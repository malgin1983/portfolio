...
import { MOBILE_REGION_BOUNDS, MOBILE_GAP } from '../constants/mobile';
...
export const StarrySkyMobileChart: React.FC<IStarrySkyMainChart> = ({ dimensions, targetYear }) => {
    ...
    const mobileSectionHeight = (height - 4 * MOBILE_GAP) / 5;
    ...
    useEffect(() => {
        ...
        const scale = (xMin: number, xMax: number, yMin: number, yMax: number) => ({
            ...
            y: d3.scaleLinear().domain([yMin, yMax]).range([mobileSectionHeight, 0]),
        });
    ...
    return (
        <div className="starry-sky-mobile">
            <svg ref={svg1Ref} width={width} height={mobileSectionHeight} className="starry-sky-mobile__section" />
            <svg ref={svg2Ref} width={width} height={mobileSectionHeight} className="starry-sky-mobile__section" />
            <svg ref={svgStarRef} width={width} height={mobileSectionHeight} className="starry-sky-mobile__section" />
            <svg ref={svg3Ref} width={width} height={mobileSectionHeight} className="starry-sky-mobile__section" />
            <svg ref={svg4Ref} width={width} height={mobileSectionHeight} className="starry-sky-mobile__section" />
        </div>
    );
};
